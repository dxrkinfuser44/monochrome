...
- [README](../README.md) — product overview and user-facing quick start.
- [CONTRIBUTING](../CONTRIBUTING.md) — contribution workflow and standards.
- [DOCKER](../DOCKER.md) — Docker and self-hosted runtime guidance.
- [INSTANCES](../INSTANCES.md) — public instance list and related notes.
- [THEME_GUIDE](../THEME_GUIDE.md) — theme creation and customization.
